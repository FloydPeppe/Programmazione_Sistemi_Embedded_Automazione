...
%   om      : angular velocity [3x1]
%   mag     : magnetic field [3x1]
%   gps     : gps coordinates [unknown, doesnt work yet]
%   or      : orientation as estimated by the phone (euler angles?) [3x1]
%   lin_acc : linear accelerations, excluding gravity [3x1] (as calculated by phone)
%   grav    : direction of gravitational vector  [3x1] (as calculated by phone)
%   press   : pressure.
